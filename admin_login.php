...
<body>
    <center>
            ...
            <div class="wrapper_login">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="form-group">
                        <input type="text" autocomplete="off" name="username" placeholder="Enter your Username" class="form-control  <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>">
        ...
        <p class="link">Don't have an account? <a href="#">Contact Administration Team</a></p>
    </center>
</body>
